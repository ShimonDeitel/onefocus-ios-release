...
enum Reminders {
    private static let identifier = "onefocus.daily.reminder"
    ...
    static func schedule(hour: Int, minute: Int) {
        ...
        content.title = "What's your one focus today?"
        content.body = "Pick your single most important thing and focus."
